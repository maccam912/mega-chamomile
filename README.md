...
one difference: it's built to run on low-end computers. Old family laptops,
integrated graphics, that kind of thing. Godot 4.7 with the Compatibility
renderer, blocky low-poly characters, no fancy lighting.
